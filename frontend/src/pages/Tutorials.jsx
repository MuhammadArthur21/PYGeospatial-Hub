import { Search, BookOpen, GraduationCap, PlayCircle, Clock, ArrowRight } from 'lucide-react'
...
const tutorials = [
  {
    id: 'getting-started',
    title: 'Getting Started with PyGeospatial Hub',
  ...
  {
    id: 'geopandas-intro',
    title: 'GeoPandas for Spatial Data Analysis',
  ...
  {
    id: 'interactive-maps',
    title: 'Creating Interactive Maps with Folium',
              ...
              <CardHeader>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <span className={`text-xs font-medium ${
                    tutorial.difficulty === 'Beginner' ? 'text-green-400' :
                    tutorial.difficulty === 'Intermediate' ? 'text-yellow-400' : 'text-red-400'
                  }`}>
                    {tutorial.difficulty}
                  </span>
                </div>
